    ...
    <div className=" relative markets">
          <div className="absolute top-0 left-0 w-full h-full opacity-20 -z-50">
           ...
           <div className="w-screen mx-auto  pt-12 flex  flex-col gap-6 items-center">
            <h2 className="text-center text-2xl w-11/12 md:w-3/4 lg:w-1/2">Serving Essential Markets</h2> 
            <p className="text-center  w-11/12 md:w-3/4 lg:w-1/2">We create critical infrastructure solutions that electrify and energize our communities and economy.</p> 
        ...
        > 
          {serveses.map((servese, index) => (
            <SwiperSlide key={index}>
                <div className=" flex flex-col  justify-center items-center bg-white  h-84 border-1 shadow-md rounded-xl ">
                <img src={servese.image}  className="w-full  rounded-t-xl"/>
