...
const Hero = () => {
  return (
    <div className="relative ">
       ...
       <div className="flex w-11/12 mx-auto flex-col items-start gap-6 pt-64 pb-40">
          <h3 className="text-white text-6xl font-bold" style={{    width: '0px',
...
>>>>>>> 457c3babc576ac2898c61fef47d674df05232464
