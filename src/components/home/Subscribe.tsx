  ...
  return (
    <FadeEffect transition={0.1} direction="up" duration={ 0.4}>
      <div className="flex flex-col gap-8 items-center bg-[#BBBEBF] py-12 my-16">
          ...
          <form className="flex flex-col items-center w-11/12 md:w-3/4 lg:w-1/2 justify-center lg:flex-row gap-6">
              <input type="text" placeholder="Enter your email" className="p-4 text-xs border w-full focus:ring-gray-50 focus:border-gray-50 border-gray-300 rounded-lg outline-none"/>
