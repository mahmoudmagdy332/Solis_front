  ...
  return (
    <FadeEffect transition={0.1} direction="up" duration={ 0.4}>
      <div className="flex flex-col gap-8 items-center bg-[#BBBEBF] py-12 my-16">
          <h2 className="text-center text-2xl w-11/12 md:w-3/4 lg:w-1/2">{translations.Enjoy_our}</h2> 
          <form 
          ...
          />
           {isPending ? (
            ...
            <button className="bg-black rounded-lg text-sm text-white border hover:border-black  hover:bg-white  hover:text-black transition-all ease-in-out py-[14px] px-8">
