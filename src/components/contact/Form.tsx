...
const Form = () => {
  ...
  return (
    <div>
      <p className="text-[#4A4A4A] text-xl capitalize">{translations.Do_you_need}</p>
      <p className="text-[#848484] text-md mt-3">{translations.WeTakeGreat}</p>
      <form className="my-10" onSubmit={handleSubmit(onSubmit)}>
        <Controller
          name="name"
          control={control}
          rules={{
            required: translations.Name_required,
            maxLength: {
              value: 17,
