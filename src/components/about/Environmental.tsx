...
const Environmental = ({section}:{section:aboutSection}) => {
  return (
    <div className=" relative">
        <div className="absolute top-0 left-0 w-full h-full -z-10">
         <img  loading="lazy"  src={section.image} className="w-full h-full object-cover"/>
        </div>
        ...
        <div className="w-screen mx-auto my-10 py-20 md:py-32 lg:py-48 flex flex-col items-center gap-6 text-white">
            <h2 className="text-center text-2xl lg:text-4xl w-11/12 md:w-3/4 lg:w-1/2">{section.title}</h2> 
...
<p
          ...
          className=" text-center text-md lg:text-xl w-11/12 md:w-3/4 leading-8  text-white "
        />
