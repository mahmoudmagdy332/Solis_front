...
function Products() {
  ...
  const { data: mostSelling, isLoading: mostSellingLoading } = mostSellingQuery();

  console.log("mostSelling: ", mostSelling);
        ...
        <div className="container my-20">
          {mostSellingLoading ? (
            ...
            <div className="flex items-center justify-center gap-10">
              {mostSelling && mostSelling.map((product: productType, i: number) => (
                <Link
                  key={i}
