...
export default function Boutiques() {
  ...
  const { isLoading: marketLoading, data: marketData, isError: marketIsError, error: marketError } = useMarkets();
  ...
  return (
    <div>
      ...
      <div className="//w-10/12 //lg:w-10/12 container mt-1 mb-10 flex flex-col gap-10">
        {(projects.length === 0 || !projects) ? (<div><h1>there are no projects in this market</h1></div>) : projects.map((project, index) => (
          <div
            key={index}
