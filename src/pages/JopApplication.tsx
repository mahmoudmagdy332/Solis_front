        ...
        <div className=" w-full  mt-16 flex  items-center">
          <div className="w-10/12 lg:w-3/5  mx-auto gap-10 items-start grid grid-cols-1 md:grid-cols-3 py-10">
            <div className="flex flex-col gap-4 lg:col-span-2">
              <p className="text-white font-medium text-2xl">{career?.title}</p>

              <div className="text-white">
                {career?.type} / {career?.place} / Open
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-span-3">
            <div className="flex flex-col gap-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 items-center justify-start gap-y-8">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <JopInput {...field} error={errors?.linked_in?.message} />
                  )}
                />
                {/* <p
              ...
              <p>{translations.interestedSolis}</p>
              ...
              <div className="grid grid-cols-1  items-center justify-start gap-y-8">
                <p>{translations.AdditionInformation}</p>
                <Controller
            ...
            <div className="flex justify-center my-20">
              {isPending ? (
                <button
                  type="button"
                  className="py-3 px-8 text-white bg-black  cursor-not-allowed font-medium rounded-lg text-lg  text-center flex items-center gap-2"
                  disabled
                >
